				...
				<header id="masthead" class="site-header" role="banner">
					<div class="site-header-main">
						<div class="site-branding">
							<?php if($logo) : ?>
		                        <div id="parent">
		                            <a href="<?php echo $logoLink;?>" title="<?php echo __('VHL Events Calendar','vhl');?>"> 
		                                <img src="<?php echo $logo;?>" alt="<?php echo __('Site Logo','bvs-events-calendar');?>"/>
		                            </a>
		                        </div>
		                    <?php endif; ?>
							...
							<?php else : ?>
								<div class="site-name">
									<p class="site-title"><a href="<?php echo $bannerLink ? $bannerLink : esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></p>
